...
public class OrderService {
    ...
    @KafkaListener(topics = "TopicForOrders")
    public void orderListener(OrderKafkaDto orderKafkaDto){
        createOrder(orderKafkaDto.getUsername(), orderKafkaDto.getOrderDetailsDto(), orderKafkaDto.getCartName());
    }
